...
export const readConfiguration = () => {
  const envVars = {
    ...
    authUrl: process.env.CTP_AUTH_URL as string ?? 'https://auth.europe-west1.gcp.commercetools.com',
    apiUrl: process.env.CTP_API_URL as string ?? 'https://api.europe-west1.gcp.commercetools.com', 
