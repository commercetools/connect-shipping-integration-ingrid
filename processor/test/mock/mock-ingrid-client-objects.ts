...
export const mockIngridCheckoutSessionWithDeliveryAddons: IngridGetSessionResponse = {
  session: {
    checkout_session_id: 'mock-ingrid-session-id',
    status: 'active',
    updated_at: '2023-01-01T00:00:00Z',
    ...
    delivery_groups: [
      {
        ...
        shipping: {
          ...
          carrier: 'standard',
          carrier_product_id: 'MPC',
          delivery_addons: [{ id: 'dummy-addon-id', external_addon_id: 'dummy-external-addon-id' }],
          delivery_type: 'pickup',
          meta: {},
          product: 'standard',
          route: {
...
export const mockIngridCheckoutSessionWithMultipleGroups: IngridGetSessionResponse = {
  session: {
    checkout_session_id: 'mock-ingrid-session-id',
    status: 'active',
    updated_at: '2023-01-01T00:00:00Z',
    ...
    delivery_groups: [
      {
        ...
        shipping: {
          addons: [],
          carrier: 'standard',
          carrier_product_id: 'STD',
          delivery_addons: [],
          delivery_type: 'delivery',
          meta: {},
          product: 'standard',
          route: { shipping_legs: [] },
          supports: { courier_instructions: false, customer_number: false, door_code: false, search: false },
          warehouse: {
            address: {
              address_lines: ['Warehouse St 1'],
              city: 'Stockholm',
              postal_code: '11122',
              country: 'SE',
              apartment_number: '',
        ...
        pricing: { currency: 'SEK', price: 2500, price_components: [] },
        selection: { auto_selected: false, selected_by: 'customer', selected_by_type: 'manual' },
        addresses: {
          billing_address: {
            first_name: 'John',
            last_name: 'Doe',
        ...
        category: {
          ...
          presented_category_name: 'Standard',
          base_price: 2500,
          custom_text: '',
          custom_warning_text: '',
          tags: [],
        ...
        delivery_time: {
          pickup_from_merchant: { earliest: '2025-02-04T00:00:00+01:00', latest: '2025-02-04T00:00:00+01:00' },
          customer_delivery_promise: { earliest: '2025-02-06T00:00:00+01:00', latest: '2025-02-07T00:00:00+01:00' },
          carrier_delivery_promise: { earliest: '2025-02-06T00:00:00+01:00', latest: '2025-02-07T00:00:00+01:00' },
        },
        group_id: 'group-a',
      ...
      },
      {
        items: [
          {
            ...
            site_external_id: 'site-2',
          },
        ],
        shipping: {
          addons: [],
          carrier: 'express',
          carrier_product_id: 'EXP',
          delivery_addons: [],
          delivery_type: 'delivery',
          meta: {},
          product: 'express',
        ...
        pricing: { currency: 'SEK', price: 4900, price_components: [] },
        selection: { auto_selected: false, selected_by: 'customer', selected_by_type: 'manual' },
        addresses: {
          billing_address: {
            first_name: 'John',
        ...
        category: {
          ...
          presented_category_name: 'Express',
          base_price: 4900,
          custom_text: '',
          custom_warning_text: '',
          tags: [],
        ...
        delivery_time: {
          pickup_from_merchant: { earliest: '2025-02-04T00:00:00+01:00', latest: '2025-02-04T00:00:00+01:00' },
          customer_delivery_promise: { earliest: '2025-02-05T00:00:00+01:00', latest: '2025-02-05T00:00:00+01:00' },
          carrier_delivery_promise: { earliest: '2025-02-05T00:00:00+01:00', latest: '2025-02-05T00:00:00+01:00' },
        },
        group_id: 'group-b',
  ...
  html_snippet: '<div>mock-html-snippet-multi</div>',
};

export const mockIngridCheckoutSessionWithInstaboxToken: IngridGetSessionResponse = {
  session: {
    checkout_session_id: 'mock-ingrid-session-id',
    status: 'active',
    updated_at: '2023-01-01T00:00:00Z',
    ...
    delivery_groups: [
      {
        ...
        shipping: {
          ...
          delivery_addons: [],
          delivery_type: 'pickup',
          meta: { 'isb.availability_token': 'dummy-instabox-availability-token' },
          product: 'standard',
          route: {
            shipping_legs: [],
          },
