...
describe('Helper Functions', () => {
  ...
  describe('transformIngridDeliveryGroupsToCommercetoolsDataTypes', () => {
    ...
    test('should throw error when pickup point ID is not set on delivery type is pickup', () => {
      ...
      expect(() => transformIngridDeliveryGroupsToCommercetoolsDataTypes(deliveryGroupWithPickupPointId)).toThrow(
        CustomError,
      );
      expect(() => transformIngridDeliveryGroupsToCommercetoolsDataTypes(deliveryGroupWithPickupPointId)).toThrow(
        'Pickup point ID is not set even though delivery type is pickup',
      );
    });
